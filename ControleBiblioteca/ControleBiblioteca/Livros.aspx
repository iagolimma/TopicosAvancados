<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Livros.aspx.cs" Inherits="ControleBiblioteca.Livros" %>
    ...
    <form id="form1" runat="server">
        <article class="kanban-entry grab" id="item1" draggable="true">
            <div class="kanban-entry-inner">
                <div class="kanban-label">
                    <h2><a href="#">Cadastro De livros</a> <span></span></h2>
                    <p></p>
                </div>
            </div>
        </article>
        ...
        <div class="form-group">
            <label for="Cor">Autor:</label>
            <asp:TextBox class="form-control" name="txtAutor" ID="txtAutor" runat="server"></asp:TextBox>
        </div>
