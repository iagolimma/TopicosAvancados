<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Aluno.aspx.cs" Inherits="Projescola.Aluno" %>
...
<body>
    <h1><div align="center"> Cadastro de Aluno</h1>
     ...
     <form id="form1" runat="server">
        <div>
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TxtEndereco" runat="server" Width="186px"></asp:TextBox> 
                    </td>
                </tr>
                <tr>
                    <td>
       ...
       <div align="center">
       <a href="Materia.aspx"> -----CLIQUE AKI PARA IR PARA  PAGINA DE CADASTRO DE MATERIA---------</a>
   </div>
    </form>
</body>
</html>
